...
@onready var logo_container := $AspectNode/CanvasLayer2/LogoContainer
@onready var logo := $AspectNode/CanvasLayer2/LogoContainer/Logo
@onready var circle := $AspectNode/CanvasLayer2/LogoContainer/Circle
...
@export_file("*.png") var logo_path = "res://addons/awesome_splash/circle_jump_01/logo.png"
@export var title :String= "GODOT"
@export var description :String= "made with godot engine"

@export var background_color:Color = Color8(0, 0, 0, 255)
@export var logo_color:Color =  Color8(255, 255, 255, 255)
@export var font_color:Color = Color.WHITE
@export var title_font_size :float = 230
@export var description_font_size :float = 120

const SPACE_LOGO_AND_TITLE := 10.0
...
func config():
	...
	var shift_x = (SPACE_LOGO_AND_TITLE + logo_size()) / 2.0 - 280
	...
	info_node.position = center_point + Vector2(0, 100)
...
func start_main_animation():
	...
	var shift_x = (title_node.width + SPACE_LOGO_AND_TITLE) / 2.0 + 50
...
func fade_logo_animation():
	SoundManager.play_ui_sound(load("res://asset/sfx/jump.tres"))
...
func play_sound():
	SoundManager.play_ui_sound(load("res://asset/sfx/beep.tres"))
